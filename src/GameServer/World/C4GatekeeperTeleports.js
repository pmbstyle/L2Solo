const DESTINATIONS = {
    ...
    462: [49315, 248452, -5960, 2500], 1001: [-99678, 237562, -3567, 200], 1002: [-101294, 212553, -3093, 3000], 1003: [-113329, 235327, -3653, 2500], 1004: [-107456, 242669, -3493, 2300], 136: [47942, 186764, -3485, 6300]
};

const LISTS = {
    7006: [[15, 'The Village of Gludin'], [1001, 'Obelisk of Victory'], [1002, 'Western Territory of Talking Island'], [462, 'Elven Ruins'], [1004, 'Singing Waterfall']],
