...
const DataCache = {
    init: () => {
        ...
        DataCache.npcs            = [
            ...
            ...validateModel(path + 'Npcs/c4_mithril_mines'),
        ...
        DataCache.npcSpawns       = [
            ...
            ...validateModel(path + 'Npcs/Spawns/c4_mithril_mines'),
        ...
        DataCache.npcRewards      = [
            ...
            ...validateModel(path + 'Npcs/Rewards/c4_mithril_mines'),
        ...
        DataCache.items = [
            ...
            ...validateModel(path + 'Items/Others/c4_mithril_mines'),
