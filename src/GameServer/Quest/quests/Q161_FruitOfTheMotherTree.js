...
module.exports = {
  ...
  async onEvent(s, e) {
    ...
    return p("Andellia", "Take this letter to Thalia.");
  },
  async onTalk(s, n) {
    ...
    if (!s.isStarted())
      return id === A &&
        ...
        ? p(
            "Andellia",
            "Will you help the Mother Tree?",
            '<a action="bypass -h quest 161 start">Accept.</a>',
          )
    ...
    if (id === A && s.getInt("cond") === 2) {
      ...
      await s.exit(false);
      return p("Andellia", "The Mother Tree thanks you.");
    }
