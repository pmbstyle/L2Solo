...
const Opcodes = {
    table: (() => {
        ...
        table[0x89] = require('./Request/PetInventory').rename;
        table[0x8a] = require('./Request/PetInventory').use;
        table[0x8b] = require('./Request/PetInventory').deposit;
        table[0x8c] = require('./Request/PetInventory').withdraw;
