...
function petInfo(summon, owner, val = 1) {
    ...
    packet
        ...
        .writeD(0)
        .writeC(owner ? 1 : 0)
        .writeC(summon.fetchStateRun?.() === false ? 0 : 1)
        ...
        .writeD(summon.fetchCollectiveCastSpd())
        .writeD(0)
        .writeH(summon.fetchIsPet?.() && [12526, 12527, 12528].includes(Number(summon.fetchSelfId?.())) ? 1 : 0)
        .writeC(0)
        .writeH(0)
        .writeC(0)
        .writeD(0)
