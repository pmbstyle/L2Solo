const DEFAULTS = {
    ...
    // Stagger the first shared-hunt review; this is no longer a hard lifetime.
    // Later reviews use goals, progress, relationships and individual patience.
    partySessionMaxMs: 20 * 60 * 1000,
    partyReviewIntervalMs: 5 * 60 * 1000,
